...
\toprule
\textbf{Architecture}  & \textbf{Params} & \textbf{Top-1 Acc.} & \textbf{Off-by-1 Acc.} & \textbf{MAE} & \textbf{Positional Acc.} \\ \midrule
MLP-5 & 1.32M & 58.18\% & 88.05\% & 0.622 & 56.66\% \\
SE-ResNet-16 & 1.22M & 69.87\% & 94.72\% & 0.384 & 70.08\% \\
Transformer-6 & 1.21M & \textbf{73.04\%} & \textbf{95.83\%} & \textbf{0.333}& \textbf{73.21\%} \\ \bottomrule
\end{tabular}
\end{table}
